...
**Текущее состояние: этап 1, ветка `feat/stage1-auth`.** Реализованы фундамент, схема базы,
health/readiness, структурированные логи, а также авторизация, управление сотрудниками
и курьерами, роли и аудит. Интерфейс, realtime и деплой-каркас идут следующими ветками —
