...
План выкатки на production:
 ...
 10. проверить подложку по манифесту и пересчитать SHA-256 tiles.tar на сервере,
 ...
 12. поднять маршрутизатор, дождаться набора тайлов и посчитать пробную матрицу
