...
План выкатки на staging:
 ...
 10. посчитать пробную матрицу на синтетических точках обоими профилями
 11. только после этого применить миграции (prisma migrate deploy)
 12. запустить приложение из точной версии образа
