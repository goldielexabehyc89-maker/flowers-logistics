...
export const REALTIME_TOPICS = [
  ...
  // Очередь «Ожидают приёмки» изменилась отгрузкой листа курьеру. Своя тема,
  // потому что раздел открыт управляющему и менеджеру выдачи, а складской
  // поток комплектования им намеренно не рассылается. В payload только
  // идентификатор листа.
  'warehouse.awaiting_changed',
