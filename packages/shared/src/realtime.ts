...
export const REALTIME_TOPICS = [
  ...
  'print_job.changed',
  // Локальный обработчик печати (`FUL-006`). Адресуется ADMIN: устройствами
  // управляет только он. В payload — идентификатор устройства и вид события:
  // ни токена, ни кода привязки, ни имени принтера там нет.
  'print_agent.device_changed',
