...
export const CONFLICT_KINDS = [
  ...
  /**
   * У смены не выбрана точка печати, а печатать есть куда.
   *
   * Не ошибка человека, а недостающий выбор: интерфейс показывает список
   * точек и повторяет действие. Молча собрать без наклейки нельзя — флорист
   * ушёл бы с букетом без этикетки и узнал бы об этом на складе.
   */
  'PRINT_POINT_REQUIRED',
