...
export const AUDIT_ACTIONS = [
  ...
  'DEPOT_DEACTIVATED',
  'DEPOT_ACTIVATED',
  // Готовность заказа к отгрузке (этап 6.1). Автор — всегда человек:
  // автоматика это состояние не меняет. В записи только прежнее и новое
  // состояние, версия и идентификаторы — ни номера заказа, ни денег.
  'ORDER_SHIPMENT_READINESS_CHANGED',
