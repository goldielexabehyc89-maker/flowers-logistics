...
export const AUDIT_ACTIONS = [
  ...
  'ROUTE_ORDERS_MOVED',
  'ROUTE_ORDER_REMOVED_FROM_ACTIVE',
  ...
  'PICKUP_ORDER_ISSUED',
  // Локальная отмена самовывоза: заказ убран из очереди самовывоза, но НЕ
  // отменён глобально и в МойСклад ничего не уходит. В записи — идентификатор
  // отмены; роль исполнителя и время фиксируются самой записью и аудитом.
  'PICKUP_CANCELLED_LOCALLY',
  ...
  // Импорт выплат из выписки ПланФакта. В записи — хеш файла, число строк,
  // проведённых и пропущенных, итог и идентификаторы записей. Ни имён
  // контрагентов, ни телефонов: они в аудит не попадают.
  'FINANCE_PAYOUT_IMPORTED',
