...
export const RESERVED_MONTHS: Readonly<Record<string, readonly ReservedMonth[]>> = Object.freeze({
  ...
  'apps/api/src/modules/fulfillment/dispatch.critical.test.ts': Object.freeze(['2029-05']),
  ...
  'apps/api/src/modules/finance/finance-matrix.critical.test.ts': Object.freeze(['2030-09']),
