...
const configSchema = z.object({
  ...
  /**
   * Автоматическое фоновое геокодирование и серверные подсказки адреса.
   *
   * Флаг общий намеренно: и то, и другое отправляет наружу адрес клиента,
   * и разрешать одно без другого значило бы обманывать себя.
   */
   ...
   * контейнера.
   */
  PHOTON_URL: z.string().min(1).optional(),
