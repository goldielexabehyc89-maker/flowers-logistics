...
export const PLACEHOLDERS: Record<string, PlaceholderProps> = {
  deals: {
    title: 'Сделки',
    stage: '3 — синхронизация заказов',
    description:
      'Доставки выбранной даты: список, карта, фильтры и группы «Требуют внимания», «Нераспределённые», «Черновики», «Подтверждённые», «Отгруженные», «Завершённые».',
    upcoming: [
      'импорт заказов из МоегоСклада с идемпотентными webhooks',
      'исправление адреса, интервала, получателя и телефона',
      'разрешение конфликтов между локальными и внешними значениями',
    ],
  },
  routing: {
    title: 'Маршрутизация',
