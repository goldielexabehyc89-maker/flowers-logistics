...
export const PLACEHOLDERS: Record<string, PlaceholderProps> = {
  // Разделов «Флорист», «Склад», «Активные» и «История» здесь больше нет: все
  // четыре реализованы (`screens/florist`, `screens/warehouse`,
  // `screens/delivery`). Оставленная заглушка перехватывала бы тот же адрес
  // и показывала бы «раздел не реализован» поверх работающего экрана.
  pickup: {
    title: 'Самовывоз',
