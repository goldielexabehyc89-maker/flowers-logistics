...
export const LOGISTICS_HISTORY: PlaceholderProps = {
  title: 'История',
  stage: '7 — операционная история логистики',
  description: 'Завершённые маршрутные дни, изменения составов и решения логистов.',
  upcoming: [
    'история маршрутов по дням и курьерам',
    'кто и когда менял состав, порядок и курьера',
    'поиск по номеру заказа внутри истории',
  ],
};

/** Вкладка «Отчёты» раздела «Логистика». */
export const LOGISTICS_REPORTS: PlaceholderProps = {
  title: 'Отчёты',
