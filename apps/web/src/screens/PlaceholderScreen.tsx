...
export const PLACEHOLDERS: Record<string, PlaceholderProps> = {
  // Разделов «Флорист» и «Склад» здесь больше нет: оба реализованы
  // (`screens/florist` и `screens/warehouse`). Оставленная заглушка
  // перехватывала бы тот же адрес и показывала бы «раздел не реализован»
  // поверх работающего экрана.
  pickup: {
    title: 'Самовывоз',
