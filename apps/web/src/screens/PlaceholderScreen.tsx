...
export const PLACEHOLDERS: Record<string, PlaceholderProps> = {
  // Разделов «Флорист», «Склад» и «Самовывоз» здесь больше нет: все три
  // реализованы (`screens/florist`, `screens/warehouse`, `screens/pickup`).
  // Оставленная заглушка перехватывала бы тот же адрес и показывала бы
  // «раздел не реализован» поверх работающего экрана.
  active: {
    title: 'Активные',
